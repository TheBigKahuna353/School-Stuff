...
const getOne = (id) => __awaiter(void 0, void 0, void 0, function* () {
    logger_1.default.info(`Getting user with id ${id} from the database`);
    const conn = yield (0, db_1.getPool)().getConnection();
...
const insert = (username) => __awaiter(void 0, void 0, void 0, function* () {
    logger_1.default.info(`Inserting user with username ${username} into the database`);
    const conn = yield (0, db_1.getPool)().getConnection();
...
const alter = (id, username) => __awaiter(void 0, void 0, void 0, function* () {
    logger_1.default.info(`Updating user in the database`);
    const conn = yield (0, db_1.getPool)().getConnection();
...
const remove = (id) => __awaiter(void 0, void 0, void 0, function* () {
    logger_1.default.info(`Deleting user with id ${id} from the database`);
    const conn = yield (0, db_1.getPool)().getConnection();
