...
class Scanner:
    ...
    def get_token(self):
        ...
        # print("self.current_char_index: ", self.current_char_index)
        ...
        # check to see if there are extra characters that do not match any token
        if self.current_char_index + len(longest) < len(self.input_string):
            char = self.input_string[self.current_char_index + len(longest)]
            if not char.isspace():
